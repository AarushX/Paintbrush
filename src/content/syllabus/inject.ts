...
import SyllabusViewer from './SyllabusViewer.svelte';
import tailwindCss from '../../styles/tailwind.css?inline';

const HOST_ID = 'paintbrush-syllabus-root';
...
export function mountSyllabusViewer(courseId: number): () => void {
  ...
  const app = mount(SyllabusViewer, { target: appRoot, props: { courseId } });
