...
export function mountInboxViewer(): () => void {
  ...
  host.id = HOST_ID;
  host.style.cssText = 'all: initial; display: block; position: fixed; top: 0; left: 0; right: var(--pb-sidebar-w, 340px); bottom: 0; overflow: hidden; background: transparent; z-index: 1; transition: right 300ms cubic-bezier(0.22,0.61,0.36,1); pointer-events: auto;';
