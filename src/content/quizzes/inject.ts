...
import QuizzesViewer from './QuizzesViewer.svelte';
import tailwindCss from '../../styles/tailwind.css?inline';

const HOST_ID = 'paintbrush-quizzes-root';
...
export function mountQuizzesViewer(courseId: number): () => void {
  ...
  const app = mount(QuizzesViewer, { target: appRoot, props: { courseId } });
