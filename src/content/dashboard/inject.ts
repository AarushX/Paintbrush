...
const HOST_ID = 'paintbrush-dashboard-root';

// Aggressive — Canvas's dashboard has many widgets all over the place
...
export function mountDashboardViewer(): () => void {
  ...
  const app = mount(DashboardViewer, { target: appRoot });
