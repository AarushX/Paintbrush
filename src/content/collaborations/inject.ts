...
import CollaborationsViewer from './CollaborationsViewer.svelte';
import tailwindCss from '../../styles/tailwind.css?inline';

const HOST_ID = 'paintbrush-collaborations-root';

const HIDE_SELECTORS = ['#content', '#main', '#right-side-wrapper'];
...
export function mountCollaborationsViewer(courseId: number): () => void {
  ...
  const app = mount(CollaborationsViewer, { target: appRoot, props: { courseId } });
